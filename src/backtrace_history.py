...
def run_bencharm(file_path, short, medium, long, rsi_duration, rsi_top, rsi_bottom, use_vwap, investment, com_pot):
    # 1. Load both files
    ...
    for _, row in df.iterrows():
        ...
        if ema_short > ema_medium and not seen and rsi_bottom < rsi_val < rsi_top and close > vwap and ema_short > ema_long:
                    ...
                    for rsi_top_entry in rsi_top_list:
                        for rsi_bottom_entry in rsi_bottom_list:
                            for vwap_entry in vwap_list:
                                ...
                                profit = run_bencharm("../temp/history_frame_size_5.dat",
                                                      short_entry,
                                                      medium_entry,
                                                      long_entry,
                                                      rsi_entry,
