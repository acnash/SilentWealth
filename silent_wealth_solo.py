...
def scheduled_task(ib_input, stock_input, ticker_name_input, quantity_input, frame_size, stop_loss_percent,
                   dollar_amount, trade_time):
    global holding_stock
...
# Add arguments
parser.add_argument("--ticker_name", type=str, help="Ticker name e.g., BP. SOXL SOXS, and BTC for Bitcoin",
                    required=True)
parser.add_argument("--exchange", type=str, help="Exchange e.g., LSE LSEETF ARCA. Not required for Bitcoin.",
                    required=False)
...
parser.add_argument("--stop_loss_percent", type=float, help="The percent below the buy position to take as a stop-loss",
                    required=True)
